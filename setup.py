...
setup(
    ...
    packages=['gtdbtk', 'gtdbtk.biolib_lite', 'gtdbtk.config', 'gtdbtk.external',
              'gtdbtk.external.Bio.Pfam.Active_site', 'gtdbtk.external.Bio.Pfam.HMM', 'gtdbtk.external.Bio.Pfam.Scan'],
    scripts=['bin/gtdbtk'],
