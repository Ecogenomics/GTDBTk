...
class InferRanks():
    ...
    def _get_ingroup_domain(self, ingroup_taxon):
        ...
        if ingroup_domain is None: 
            raise GTDBTkExit(f'Ingroup taxon {ingroup_taxon} was not found in GTDB taxonomy.')
            
        return ingroup_domain
        
    def _get_median_reds(self, ingroup_taxon, ingroup_domain):
            ...
            if taxon:
                ...
                if ingroup_taxon in taxa:
                    if ingroup_node is not None:
                        raise GTDBTkExit(f'Ingroup taxon {ingroup_taxon} identified multiple times.')
                    ingroup_node = node
    ...
    def _find_ingroup_red(self, ingroup_node, ingroup_domain, tree):
        ...
        raise GTDBTkExit(f'Could not determine RED of ingroup taxon {ingroup_taxon}.')
    ...
    def run(self, 
        ...
        # get median RED values for domain of ingroup taxon
        median_reds = self._get_median_reds(ingroup_taxon, ingroup_domain)
